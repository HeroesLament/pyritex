...
STRUCT_FILES = [
    ROOT / "pyritex" / "netlink" / "socket.py",
    ROOT / "pyritex" / "netlink" / "message.py",
]
...
def generate_init():
    ...
    # Constant-like utility functions (manually specified)
    for func in CONST_FUNCTION_EXPORTS:
